...
class TestInfrastructureLayerRules:
    def test_importing_domain_passes(self, layer_patterns) -> None:
        ...
        assert check_layer_rules(test_mod, "infrastructure", layer_patterns) == []
    ...
    def test_importing_presentation_violates(self, layer_patterns) -> None:
        ...
        violations = check_layer_rules(test_mod, "infrastructure", layer_patterns)
